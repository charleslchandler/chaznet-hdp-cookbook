...
artifact_server = node[:artifacts][:host]
hdp_version     = '2.3.4.0'
...
when 'redhat', 'centos'
  ...
  yum_repository "HDP-2.3" do
    description "HDP-2.3"
    baseurl "http://#{artifact_server}/hdp/HDP/centos$releasever/2.x/updates/#{hdp_version}"
    gpgkey "http://#{artifact_server}/hdp/HDP/centos$releasever/2.x/updates/#{hdp_version}/RPM-GPG-KEY/RPM-GPG-KEY-Jenkins"
    gpgcheck true
    action :create
    proxy '_none_'
  end
  ...
  yum_repository "HDP-UTILS" do
    ...
    baseurl "http://#{artifact_server}/hdp/HDP-UTILS-1.1.0.20/repos/centos$releasever"
    gpgkey "http://#{artifact_server}/hdp/HDP-UTILS-1.1.0.20/repos/centos$releasever/RPM-GPG-KEY/RPM-GPG-KEY-Jenkins"
    gpgcheck true
    action :create
    proxy '_none_'
  end
...
when 'ubuntu', 'deban'
  ...
  #apt_repository 'HDP-2.3' do
  #  uri "http://#{artifact_server}/hdp/HDP/centos6/2.x/updates/#{hdp_version}"
  #  components ['main']
  #  distribution 'Ambari'
